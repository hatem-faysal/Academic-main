                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="text-center">
                                        <h3 class="">Sign Up Teacher</h3>
                                        <p>Already have an account? <a href="{{ route('teacher.auth.login.store') }}">Sign in
                                                here</a>
                                        </p>
                                    </div>
                                    <div class="d-grid">
                                    ...
                                    <div class="form-body">
						                <form method="POST" class="row g-3" action="{{ route('teacher.auth.register.store') }}">
						                    @csrf
						                    @method('POST')
						                    <input type="hidden" value="teacher" name="roles">
                                            <div class="col-sm-6">
                                                <label for="inputFirstName" class="form-label">First Name</label>
                                                <input type="text" required class="form-control" name="firstname" value="{{ old('firstname') }}" id=""
                                                    placeholder="Jhon">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="inputLastName" class="form-label">Last Name</label>
                                                <input type="text" required class="form-control" name="lastname" value="{{ old('lastname') }}" id=""
                                                    placeholder="Deo">
                                            </div>
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Email Address</label>
                                                <input type="email" required name="email" value="{{ old('email') }}" class="form-control" id="inputEmailAddress"
