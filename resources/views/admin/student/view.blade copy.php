...
<div class="content-body">
    <x-admin.route :route="route('admin.student.create')" name="{{ ('Create Student') }}">
    </x-admin.route>
    <!-- container starts -->
                        ...
                        <div class="col-xl-12">
                            <div class="card dz-card" id="accordion-one">
                                <div class="card-header flex-wrap">
                                    <x-admin.basic name="{{ ('Student') }}"></x-admin.basic>
                                    {{-- <x-admin.search :route="route('admin.admins.index')"></x-admin.search> --}}
                                </div>
                                <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a href="{{ route('admin.student.create') }}" class="nav-link active"
