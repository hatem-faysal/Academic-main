...
@section('title')
{{ str_replace("-"," ",ucfirst($type.' teacher')) }}
@endsection
...
<div class="content-body">
    <x-admin.route :route="route('admin.admins.index')" name="{{ ('Index teacher') }}"></x-admin.route>
    <!-- container starts -->
    <div class="container-fluid">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                ...
                <x-admin.crud name="{{ $type??'' }} {{ ('Form teacher') }}"></x-admin.crud>
                <div class="card-body">
                    <div class="basic-form">
                        <form method="POST" action="{{$action}}">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.label-end
                                        name="Please Enter teacher First Name">
                                    </x-admin.form.label-end>
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.label-end
                                        name="Please Enter teacher Last Name">
                                    </x-admin.form.label-end>
                                </div>
                                <div class="mb-3 col-md-6">
                            ...
                            <x-admin.form.submit :route="route('admin.teacher.index')"></x-admin.form.submit>
                        </form>
                    </div>
                </div>
            </div>
