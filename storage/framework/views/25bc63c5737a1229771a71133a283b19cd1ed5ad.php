							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Sign in Student</h3>
										<p>Don't have an account yet? <a href="<?php echo e(route('student.auth.register.store')); ?>">Sign up
												here</a>
										</p>
									</div>
									<div class="d-grid">
									...
									<div class="form-body">
						                <form method="POST" class="row g-3" action="<?php echo e(route('student.auth.login.store')); ?>">
						                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hatem/Desktop/Academic/resources/views/auth/student/login.blade.php ENDPATH**/ ?>